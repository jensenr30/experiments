...
#define ERROR_FORMAT_F "Seconds= %7.3f\t%s\t%e\n"

//--------------------------------------------------
// gamelog stuff
//--------------------------------------------------
// this is the file that gamelog prints to
#define GAMELOG_FILE "ssvlog.txt"
...
#define SSVLOG_FORMAT "Seconds = %7.3f\t%s\n"
#define SSVLOG_FORMAT_D "Seconds = %7.3f\t%s\t%d\n"
#define SSVLOG_FORMAT_F "Seconds = %7.3f\t%s\t%g\n"
#define SSVLOG_FORMAT_s "Seconds = %7.3f\t%s\t%s\n"
