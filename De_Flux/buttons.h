...
// button text colors
SDL_Color buttonColorOver = {0,0,0};
SDL_Color buttonColorUpRed = {0,0,0};//{0xb7, 0x48, 0x48 };
SDL_Color buttonColorUpBlue =   {0,0,0};//{ 0x3d, 0x63, 0xa8 };
...
struct button b_optionsWidthUp, b_optionsWidthDown, b_optionsHeightUp, b_optionsHeightDown, b_optionsChangePlayerSpeed;

//struct buttonSet gameplayButtons;
...
void init_buttons()
{
	...
	//--------------------------------------------------------------------------------------------------
	/*
	gameplayButtons.buttons[0] = &b_mmOptions;
	gameplayButtons.totalButtons = 1;
	*/
	//--------------------------------------------------------------------------------------------------
	// optionsButtons
	//--------------------------------------------------------------------------------------------------
//buttonSet
	...
	optionsButtons.buttons[4] = &b_optionsChangePlayerSpeed;
	optionsButtons.totalButtons = 5;
	
//buttons
	b_optionsChangePlayerSpeed.state = b_optionsWidthUp.state = b_optionsWidthDown.state = b_optionsHeightUp.state = b_optionsHeightDown.state = UP;
	b_optionsWidthUp.text = "w++";
	b_optionsWidthDown.text = "w--";
	b_optionsHeightUp.text = "h++";
	b_optionsHeightDown.text = "h--";
	b_optionsChangePlayerSpeed.text = "Change Player Speed";
	
	b_optionsChangePlayerSpeed.font = b_optionsHeightUp.font = b_optionsHeightDown.font = b_optionsWidthUp.font = b_optionsWidthDown.font = sansFont;
	
	b_optionsChangePlayerSpeed.colorDown = b_optionsChangePlayerSpeed.colorOver = b_optionsChangePlayerSpeed.colorUp   = colorBlack;
	...
	b_optionsChangePlayerSpeed.pos.x = 0;
	b_optionsChangePlayerSpeed.pos.y = b_optionsHeightUp.pos.y + b_optionsHeightUp.pos.h + 8;
	b_optionsChangePlayerSpeed.pos.w = 256;
	b_optionsChangePlayerSpeed.pos.h = 48;
	
	b_optionsChangePlayerSpeed.over = blueButtonOver;
	b_optionsChangePlayerSpeed.up   = blueButtonUp;
	b_optionsChangePlayerSpeed.down = blueButtonDown;
	...
	b_optionsChangePlayerSpeed.textOffset.x = 15;
	b_optionsChangePlayerSpeed.textOffset.y = 2;
...
//buttonSet
	...
	mapMakerButtons.buttons[0] = &b_mmTiles;
	mapMakerButtons.buttons[1] = &b_inventoryArea;
	mapMakerButtons.buttons[2] = &b_mmItems;
	mapMakerButtons.totalButtons = 3;
...
//buttons
	...
	/*
	b_play.pos.y = 		SCREEN_HEIGHT/2 + vertComp - imageHeightby2 - b_play.pos.h/2 - 48;
	b_mapMaker.pos.y = 	SCREEN_HEIGHT/2 + vertComp - imageHeightby2 - b_mapMaker.pos.h/2;
	b_help.pos.y = 		SCREEN_HEIGHT/2 + vertComp + imageHeightby2 - b_help.pos.h/2;
	b_options.pos.y =   SCREEN_HEIGHT/2 + vertComp + imageHeightby2 - b_options.pos.h/2 + 48;
	b_quit.pos.y = 		SCREEN_HEIGHT/2 + vertComp + imageHeightby2 - b_quit.pos.h/2 + 48 + 48;
	*/
	b_play.pos.y = 		SCREEN_HEIGHT/2 + vertComp - b_play.pos.h/2 - 2*bSize;
	b_mapMaker.pos.y = 	SCREEN_HEIGHT/2 + vertComp - b_mapMaker.pos.h/2 - bSize;
	b_help.pos.y = 		SCREEN_HEIGHT/2 + vertComp - b_help.pos.h/2;
	b_options.pos.y =   SCREEN_HEIGHT/2 + vertComp - b_options.pos.h/2 + bSize;
	b_quit.pos.y = 		SCREEN_HEIGHT/2 + vertComp - b_quit.pos.h/2 + 2*bSize;
	...
	b_help.colorOver = b_options.colorOver = b_quit.colorOver = buttonColorUpBlue;
