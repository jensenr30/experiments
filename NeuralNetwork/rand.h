...
// use sgenrand(time(NULL)) for seeding the PRNG. This ensures the random numbers you get today will be different from the random numbers you get tomorrow.
...
/// this returns a 1 or a 0 based on prob.
// prob is the probability that the output will be 1
#define rand_percent(prob) ( prob >= (genrand()%100001/(100000.0)))
...
// this will check if your value is greater than a random value between 0 and 100,000
#define rand_ht_eval(value) ( value >= rand_ht() )
