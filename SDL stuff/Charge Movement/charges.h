...
#define c_empty 0
#define c_orbit 1
void setup_charges(int configuration)
{
	if(configuration == c_empty){
		number_of_used_charges = 0;
	}
	else if(configuration == c_orbit){
		number_of_used_charges = 5;
		charges[0].charge = 200;
		...
		charges[1].charge = -150;
		charges[1].position[0] = 200;
		charges[1].position[1] = 300;
		charges[1].mass = 1;
		charges[1].speed[0] = 0;
		charges[1].speed[1] = 1000;
		charges[1].exists = 1;
	
		charges[2].charge = -150;
		charges[2].position[0] = 400;
		charges[2].position[1] = 300;
		charges[2].mass = 1;
		charges[2].speed[0] = 0;
		charges[2].speed[1] = -1000;
		charges[2].exists = 1;
		
		charges[3].charge = -150;
		charges[3].position[0] = 300;
		charges[3].position[1] = 400;
		charges[3].mass = 1;
		charges[3].speed[0] = 1000;
		charges[3].speed[1] = 0;
		charges[3].exists = 1;
	
		charges[4].charge = -150;
		charges[4].position[0] = 300;
		charges[4].position[1] = 200;
		charges[4].mass = 1;
		charges[4].speed[0] = -1000;
		charges[4].speed[1] = 0;
		charges[4].exists = 1;
	}
	/*
	...
	charges[1].charge = -a;
	charges[1].position[0] = 300;
	charges[1].position[1] = 200;
	charges[1].speed[0] = b;
	charges[1].speed[1] = 0;
	charges[1].mass = 1;
	charges[1].exists = 1;
...
void update_charges()
{
	...
	//print lines
	for(i=0; i<number_of_used_charges; i++){
		if(drawLinesBetweenCharges){
			for(j=1; i+j<number_of_used_charges; j++){
				if(charges[i].position[0] >= 0 && charges[i].position[0] <= SCREEN_WIDTH && charges[i].position[1] >= 0 && charges[i].position[1] <= SCREEN_HEIGHT)
					if(charges[i+j].position[0] >= 0 && charges[i+j].position[0] <= SCREEN_WIDTH && charges[i+j].position[1] >= 0 && charges[i+j].position[1] <= SCREEN_HEIGHT)
						draw_line(screen, charges[i].position[0], charges[i].position[1], charges[i+j].position[0], charges[i+j].position[1], 1, 0xff0000ff);
			}
		}
